...
package com.deptempldapappln.config;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests()
                    ...
                    .antMatchers("/homeserv","/listEmp").hasAnyRole("MANAGERS","DEVELOPERS").antMatchers("/**").hasRole("MANAGERS")
                    .anyRequest().fullyAuthenticated()
                .and()
                    .formLogin().and().exceptionHandling().accessDeniedPage("/WEB-INF/jsp/accessdenied.jsp");;
    }
